                                    ...
                                    <div class="chart-area">
                                        ...
                                        <div class="row row-cols-1 row-cols-md g-4">
                                            <form class="row g-3" method="POST" action="">
                                                <div class="col-2">
                                                    <label for="cveLibro" class="form-label">Clave del libro</label>
                                                    <input type="text" class="form-control" id="cveLibro" name="cveLibro" placeholder="#, 1, 2, 3" required>
                                                </div>
                                                <div class="col-5">
                                                ...
                                                <div class="col-12">
                                                    <button type="submit" class="btn btn-warning" name="btnModificarLibro">Modificar Libro</button>
                                                </div>
                                            </form>
                                            <?php
                                            echo $mensaje;
